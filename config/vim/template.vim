" simplifysimplify-dark, a vim colourscheme by haystackandroid
"
...
" GUI colours
let s:g0 = '' " background
let s:g1 = '' " numberers-margin background
let s:g2 = '' " ??????
let s:g3 = '' " comments
let s:g4 = '' " numbers-margin foreground
let s:g5 = '' " default foreground 
let s:g6 = '' " ???????
let s:g7 = '' " ???????
let s:g8 = '' " ????????
let s:g9 = '' " #!/bin/bash  ${var%1}
let s:gA = '' " ??????
let s:gB = '' " paraules reservades (function, for, echo ...)
let s:gC = '' " ????????
let s:gD = '' " Strings and ||  &&
let s:gE = '' " [[ ]] ;;  
let s:gF = '' " variables in bash: $abc and own funcion names: myf
