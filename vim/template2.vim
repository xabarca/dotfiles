...
let s:style = get(g:, 'xavi2', 'dark')
let g:colors_name = "xavi2"
"}}}

" Palettes:"{{{
" ----------------------------------------------------------------------------

let s:color_bg = '#ZZZZZZ'
let s:color_comment = '#ZZZZZZ'
let s:color_markup = '#ZZZZZZ'
let s:color_constant = '#ZZZZZZ'
let s:color_operator = '#ZZZZZZ'
let s:color_tag = '#ZZZZZZ'
let s:color_regexp = '#ZZZZZZ'
let s:color_string = '#ZZZZZZ'
let s:color_function = '#ZZZZZZ'
let s:color_special = '#ZZZZZZ'
let s:color_keyword = '#ZZZZZZ'
let s:color_error = '#ZZZZZZ'
let s:color_accent = '#ZZZZZZ'
let s:color_panel = '#ZZZZZZ'
let s:color_guide = '#ZZZZZZ'
let s:color_line = '#ZZZZZZ'
let s:color_selection = '#ZZZZZZ'
let s:color_fg = '#ZZZZZZ'
let s:color_fg_idle = '#ZZZZZZ'


let s:palette = {}

let s:palette.bg = {'dark': s:color_bg,  'light': "#FAFAFA",  'mirage': "#212733"}
let s:palette.comment = {'dark': s:color_comment,  'light': "#ABB0B6",  'mirage': "#5C6773"}
let s:palette.markup = {'dark': s:color_markup,  'light': "#F07178",  'mirage': "#F07178"}
let s:palette.constant = {'dark': s:color_constant,  'light': "#A37ACC",  'mirage': "#D4BFFF"}
let s:palette.operator = {'dark': s:color_operator,  'light': "#E7C547",  'mirage': "#80D4FF"}
let s:palette.tag = {'dark': s:color_tag,  'light': "#36A3D9",  'mirage': "#5CCFE6"}
let s:palette.regexp = {'dark': s:color_regexp,  'light': "#4CBF99",  'mirage': "#95E6CB"}
let s:palette.string = {'dark': s:color_string,  'light': "#86B300",  'mirage': "#BBE67E"}
let s:palette.function = {'dark': s:color_function,  'light': "#F29718",  'mirage': "#FFD57F"}
let s:palette.special = {'dark': s:color_special,  'light': "#E6B673",  'mirage': "#FFC44C"}
let s:palette.keyword = {'dark': s:color_keyword,  'light': "#FF7733",  'mirage': "#FFAE57"}
let s:palette.error = {'dark': s:color_error,  'light': "#FF3333",  'mirage': "#FF3333"}
let s:palette.accent = {'dark': s:color_accent,  'light': "#FF6A00",  'mirage': "#FFCC66"}
let s:palette.panel = {'dark': s:color_panel,  'light': "#FFFFFF",  'mirage': "#272D38"}
let s:palette.guide = {'dark': s:color_guide,  'light': "#D9D8D7",  'mirage': "#3D4751"}
let s:palette.line = {'dark': s:color_line,  'light': "#F3F3F3",  'mirage': "#242B38"}
let s:palette.selection = {'dark': s:color_selection,  'light': "#F0EEE4",  'mirage': "#343F4C"}
let s:palette.fg = {'dark': s:color_fg,  'light': "#5C6773",  'mirage': "#D9D7CE"}
let s:palette.fg_idle = {'dark': s:color_fg_idle,  'light': "#828C99",  'mirage': "#607080"}
